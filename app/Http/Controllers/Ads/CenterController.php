...
class CenterController extends Controller{
    ...
    */
    ...
    public function index(){
        $user = auth()->user();
        SEO::setTitle('基本资料-广告主中心-'.C('WEB_SITE_TITLE'));
    ...
    public function update(){
        ...
        if($reault){
            return $this->ajaxReturn('基本资料更新成功',1,route('ads.center.index'));
        }else{
    ...
    public function password(){
        SEO::setTitle(C('WEB_SITE_TITLE').'-广告主中心-密码修改');
    ...
    public function reset(){
        ...
        if($reault){
            return $this->ajaxReturn('修改密码成功',1,route('ads.center.index'));
        }else{
