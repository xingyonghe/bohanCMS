...
class NetredOrderController extends CommonController{
    /*
    |--------------------------------------------------------------------------
    | NetredOrder Controller
    | @author xingyonghe
    | @date 2016-12-21
    |--------------------------------------------------------------------------
    |
...
//        });
    ...
    public function index(){
        SEO::setTitle('订单管理-会员中心-'.C('WEB_SITE_TITLE'));
        $lists = [];
        return view('member.netredorder.index',compact('lists'));
    }
