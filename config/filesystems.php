    ...
    */
    ...
    'disks' => [
        ...
        'picture' => [
            ...
            'savename' => array('uniqid', ''), //上传文件命名规则，函数名称
            'hash'     => true, //是否生成hash编码
            'table'    => 'picture',//图片保存数据表
            'filedata' => 'file',//设置上传到服务器端的名称
        ...
        'avatar' => [
            ...
            'savename' => array('uniqid', ''), //头像图片命名规则，[0]-函数名，[1]-参数，多个参数使用数组
            'hash'     => true, //是否生成hash编码
            'table'    => 'picture',//头像图片保存数据表
            'filedata' => 'file',//上传到服务器端接收的名称
            'filename' => '头像',//上传驱动的备注，主要用于提示错误使用，用于区别上传的类型
        ],
