        ...
        <div class="col-lg-12">
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class=" form">
                        {!! Form::open(['url' => route('admin.config.update'),'class'=>'cmxform form-horizontal tasi-form form-datas']) !!}
                        <input name="id" type="hidden" value="{{ $info->id ?? 0 }}">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-lg-10">
                                <input class="form-control " placeholder="用于分组显示的顺序"  type="text" name="sort" value="{{$info->sort ?? 0}}"/>
                            </div>
                        </div>
                        <div class="form-group ">
                            <label for="curl" class="control-label col-lg-2">配置类型</label>
                            <div class="col-lg-10">
                                {!! Form::select('type', $config_type, $info->type ?? 0, array('class' => 'form-control m-bot15')) !!}
                            </div>
                        </div>
                        <div class="form-group ">
                            <label for="curl" class="control-label col-lg-2">配置分组</label>
                            <div class="col-lg-10">
                                {!! Form::select('group', $config_group, $info->group ?? 0, array('class' => 'form-control m-bot15')) !!}
                            </div>
                        </div>
                        <div class="form-group ">
