    ...
    <div class="col-lg-12">
        <section class="panel">
            <div class="panel-body">
                <div class=" form">
                    {!! Form::open(['url' => route('admin.menu.submit'),'class'=>'cmxform form-horizontal tasi-form form-datas']) !!}
                    <div class="form-group" >
                        ...
                        <div class="col-lg-10" style="text-align: left;font-size: 14px;color:#797979">
                            菜单规则:<br/>
                            菜单名称|排序|链接|是否显示（1隐藏0显示）|样式|分组<br/>
                            菜单名称|排序|链接|是否显示（1隐藏0显示）|样式|分组<br/><br/>
                            规则说明:<br/>
                            一行一组菜单，新的菜单必须分行<br/>
                            该批量操作只针对同一父级有效
                        </div>
