...
@section('style')
    <link href="{{ asset('assets/home/assets/fancybox/source/jquery.fancybox.css') }}" rel="stylesheet" />
    <link rel="stylesheet" href="{{ asset('assets/home/assets/revolution_slider/css/rs-style.css') }}" media="screen">
    <link rel="stylesheet" href="{{ asset('assets/home/assets/revolution_slider/rs-plugin/css/settings.css') }}" media="screen">
@endsection
@section('script')
    <script type="text/javascript" src="{{ asset('assets/home/js/jquery.parallax-1.1.3.js') }}"></script>
    <script type="text/javascript" src="{{ asset('assets/home/js/jquery.easing.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('assets/home/js/link-hover.js') }}"></script>
    <script type="text/javascript" src="{{ asset('assets/home/assets/fancybox/source/jquery.fancybox.pack.js') }}"></script>
    <script type="text/javascript" src="{{ asset('assets/home/assets/revolution_slider/rs-plugin/js/jquery.themepunch.plugins.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('assets/home/assets/revolution_slider/rs-plugin/js/jquery.themepunch.revolution.min.js') }}"></script>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-sm-6 text-center">
                    <img src="{{ asset('assets/home/img/property-img.png') }}" alt="">
                </div>
                            ...
                            <div id="news" class="tab-pane active">
                                <article class="media">
                                    <a class="pull-left thumb p-thumb">
                                        <img src="{{ asset('assets/home/img/product1.jpg') }}" alt="">
                                    </a>
                                ...
                                <article class="media">
                                    <a class="pull-left thumb p-thumb">
                                        <img src="{{ asset('assets/home/img/product2.png') }}" alt="">
                                    </a>
                                    <div class="media-body">
                            ...
                            <ul class="slides about-flex-slides">
                                <li>
                                    <div class="about-testimonial-image ">
                                        <img alt="" src="{{ asset('assets/home/img/testimonial-img-1.jpg') }}">
                                    </div>
                                ...
                                <li>
                                    <div class="about-testimonial-image ">
                                        <img alt="" src="{{ asset('assets/home/img/avatar2.jpg') }}">
                                    </div>
                ...
                <ul class="bxslider">
                    <li>
                        <div class="element item view view-tenth" data-zlname="reverse-effect">
                            <img src="{{ asset('assets/home/img/works/img1.jpg') }}" alt="" />
                            <div class="mask">
                                <a data-zl-popup="link" href="javascript:;">
                                    <i class="icon-link"></i>
                                </a>
                                <a data-zl-popup="link2" class="fancybox" rel="group" href="{{ asset('assets/home/img/works/img1.jpg') }}">
                    ...
                    <li>
                        <div class="element item view view-tenth" data-zlname="reverse-effect">
                            <img src="{{ asset('assets/home/img/works/img2.jpg') }}" alt="" />
                            <div class="mask">
                                <a data-zl-popup="link" href="javascript:;">
                                    <i class="icon-link"></i>
                                </a>
                                <a data-zl-popup="link2" class="fancybox" rel="group" href="{{ asset('assets/home/img/works/img2.jpg') }}">
                                    <i class="icon-search"></i>
                                </a>
                            </div>
                        </div>
                    ...
                    <li>
                        <div class="element item view view-tenth" data-zlname="reverse-effect">
                            <img src="{{ asset('assets/home/img/works/img3.jpg') }}" alt="" />
                            <div class="mask">
                                <a data-zl-popup="link" href="javascript:;">
                                    <i class="icon-link"></i>
                                </a>
                                <a data-zl-popup="link2" class="fancybox" rel="group" href="{{ asset('assets/home/img/works/img3.jpg') }}">
                                    <i class="icon-search"></i>
                                </a>
                            </div>
                        </div>
                    ...
                    <li>
                        <div class="element item view view-tenth" data-zlname="reverse-effect">
                            <img src="{{ asset('assets/home/img/works/img4.jpg') }}" alt="" />
                            <div class="mask">
                                <a data-zl-popup="link" href="javascript:;">
                                    <i class="icon-link"></i>
                                </a>
                                <a data-zl-popup="link2" class="fancybox" rel="group" href="{{ asset('assets/home/img/works/img4.jpg') }}">
                                    <i class="icon-search"></i>
                                </a>
                            </div>
                        </div>
                    ...
                    <li>
                        <div class="element item view view-tenth" data-zlname="reverse-effect">
                            <img src="{{ asset('assets/home/img/works/img5.jpg') }}" alt="" />
                            <div class="mask">
                                <a data-zl-popup="link" href="javascript:;">
                                    <i class="icon-link"></i>
                                </a>
                                <a data-zl-popup="link2" class="fancybox" rel="group" href="{{ asset('assets/home/img/works/img5.jpg') }}">
                                    <i class="icon-search"></i>
                                </a>
                            </div>
                        </div>
                    ...
                    <li>
                        <div class="element item view view-tenth" data-zlname="reverse-effect">
                            <img src="{{ asset('assets/home/img/works/img6.jpg') }}" alt="" />
                            <div class="mask">
                                <a data-zl-popup="link" href="javascript:;">
                                    <i class="icon-link"></i>
                                </a>
                                <a data-zl-popup="link2" class="fancybox" rel="group" href="{{ asset('assets/home/img/works/img6.jpg') }}">
                                    <i class="icon-search"></i>
                                </a>
                            </div>
                        </div>
                    ...
                    <li>
                        <div class="element item view view-tenth" data-zlname="reverse-effect">
                            <img src="{{ asset('assets/home/img/works/img7.jpg') }}" alt="" />
                            <div class="mask">
                                <a data-zl-popup="link" href="javascript:;">
                                    <i class="icon-link"></i>
                                </a>
                                <a data-zl-popup="link2" class="fancybox" rel="group" href="{{ asset('assets/home/img/works/img7.jpg') }}">
                                    <i class="icon-search"></i>
                                </a>
                            </div>
                        </div>
