        ...
        <div class="juzhong">
            <div class="zhonjian">
                ...
                <div class="shuru">
                    <div class="main_nav">
                        <ul>
                            <li><a class="cd-signin" href="javascript:void(0)">网红登录</a></li>
                            <li><a class="cd-signup" href="{{ route('netred.register.form') }}">网红注册</a></li>
                        </ul>
                    </div>
                    <div class="biaodan">
                        <div class="denglu">
                            <form class="form-horizontal data-form" method="POST" action="{{ route('netred.login.post') }}" autocomplete="off">
                                ...
                                <div class="wang">
                                    <a href="{{ route('home.password.mobile') }}">忘记密码？</a>
                                </div>
                                <div class="quren">
